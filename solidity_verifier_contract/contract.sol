...
contract Halo2Verifier {
    ...
    uint256 internal constant NUM_INSTANCE_CPTR = 0x04e4;
    uint256 internal constant     INSTANCE_CPTR = 0x0504;
    ...
    uint256 internal constant THETA_MPTR = 0x0820;
    uint256 internal constant  BETA_MPTR = 0x0840;
    uint256 internal constant GAMMA_MPTR = 0x0860;
    uint256 internal constant     Y_MPTR = 0x0880;
    uint256 internal constant     X_MPTR = 0x08a0;
    uint256 internal constant  ZETA_MPTR = 0x08c0;
    uint256 internal constant    NU_MPTR = 0x08e0;
    uint256 internal constant    MU_MPTR = 0x0900;

    uint256 internal constant       ACC_LHS_X_MPTR = 0x0920;
    uint256 internal constant       ACC_LHS_Y_MPTR = 0x0940;
    uint256 internal constant       ACC_RHS_X_MPTR = 0x0960;
    uint256 internal constant       ACC_RHS_Y_MPTR = 0x0980;
    uint256 internal constant             X_N_MPTR = 0x09a0;
    uint256 internal constant X_N_MINUS_1_INV_MPTR = 0x09c0;
    uint256 internal constant          L_LAST_MPTR = 0x09e0;
    uint256 internal constant         L_BLIND_MPTR = 0x0a00;
    uint256 internal constant             L_0_MPTR = 0x0a20;
    uint256 internal constant   INSTANCE_EVAL_MPTR = 0x0a40;
    uint256 internal constant   QUOTIENT_EVAL_MPTR = 0x0a60;
    uint256 internal constant      QUOTIENT_X_MPTR = 0x0a80;
    uint256 internal constant      QUOTIENT_Y_MPTR = 0x0aa0;
    uint256 internal constant       G1_SCALAR_MPTR = 0x0ac0;
    uint256 internal constant   PAIRING_LHS_X_MPTR = 0x0ae0;
    uint256 internal constant   PAIRING_LHS_Y_MPTR = 0x0b00;
    uint256 internal constant   PAIRING_RHS_X_MPTR = 0x0b20;
    uint256 internal constant   PAIRING_RHS_Y_MPTR = 0x0b40;
    ...
    function verifyProof(
        ...
        assembly {
            ...
            // Compute quotient evavluation
            {
                ...
                let y := mload(Y_MPTR)
                {
                    let f_0 := calldataload(0x02c4)
                    let a_1 := calldataload(0x02a4)
                    let a_0 := calldataload(0x0284)
                ...
                }
                {
                    ...
                    let eval := addmod(l_0, sub(r, mulmod(l_0, calldataload(0x0364), r)), r)
                ...
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x03c4), sub(r, calldataload(0x03a4)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x0424), sub(r, calldataload(0x0404)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x02a4), mulmod(beta, calldataload(0x0324), r), r), gamma, r), r)
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(mload(INSTANCE_EVAL_MPTR), mulmod(beta, calldataload(0x0344), r), r), gamma, r), r)
            ...
            // Compute pairing lhs and rhs
            {
                ...
                }
                {
                    ...
                    let r_eval
                    r_eval := mulmod(coeff, calldataload(0x02e4), r)
                ...
                }
                {
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x03e4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x0384), r), r)
                ...
                }
                {
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0xc0), calldataload(0x0444), r), r)
                ...
                }
                {
                    ...
                    mstore(0x00, calldataload(0x01c4))
                    mstore(0x20, calldataload(0x01e4))
